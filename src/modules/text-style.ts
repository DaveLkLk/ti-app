import { svgAdd, svgBold, svgCopy, svgItalic, svgLock, svgMagic, svgPaste, svgTached, svgUnderline, svgUnlock } from "../components/Icons";
import { getEvents } from "./events/_text-style";
